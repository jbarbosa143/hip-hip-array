...
console.log("============================");
for(i =1; i <positiveNumbers.length; i++){
...
console.log("=========================================");
let sStudent = students.slice(3,10);
for(i=0; i< sStudent.length; i++){
  console.log(students[i])
  console.log(sStudent)[i];
...
console.log("==========================================");
for(i =0; i <dinosaurs; i++){
  dinosaurs.concat(dinosaurs.splice);
  console.log(dinosaurs[i]);
